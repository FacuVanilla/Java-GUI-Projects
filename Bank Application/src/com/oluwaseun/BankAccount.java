...
public class BankAccount {
    ...
    public void getLatestTransaction() {
        if (latestTransaction > 0) {
            System.out.println("You deposited: " + latestTransaction + " naira.");

        } else if (latestTransaction < 0) {
            System.out.println("You withdrew: " + latestTransaction + " naira.");
        ...
        do {
            ...
            switch(option) {
                ...
                case 'B':
                    ...
                    withdraw(amount1);
                    System.out.println("You withdrew " + amount1 + " naira. Your new balance is: " + balance + " naira.\n");
                    break;
                ...
                case 'C':
                    ...
                    deposit(amount2);
                    System.out.println("You deposited " + amount2 + " naira on your account. Your new balance is: " + balance + " naira.\n");
                    break;
